<?php
	...
	if (isset($_POST['email']))
	{
		...
		try 
		{
			...
			{
				$rezultat = $polaczenie->query("SELECT DAN_ID FROM dane WHERE DAN_EMAIL='$email'");
				...
				$rezultat = $polaczenie->query("SELECT DAN_ID FROM dane WHERE DAN_LOGIN='$nick'");
